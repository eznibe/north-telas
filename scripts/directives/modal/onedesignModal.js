...
.directive('onedesignModal', function($modal, Stock, OneDesign) {
...
//            			  $scope.modalOneDesign.hide();
            			  ...
            			  $.notify("Nueva tela asignada al barco OD.", {className: "success", globalPosition: "bottom right"});
        		  });
        	  };
        	  ...
        	  $scope.deleteOneDesignCloth = function(odCloth) {
        		  ...
        		  OneDesign.deleteCloth(odCloth).then(function(result){
        			  ...
        			  if(result.data.successful) {
        				  ...
        				  $.notify("Tela eliminada del barco OD.", {className: "success", globalPosition: "bottom right"});
        			  }
        		  });
        	  };
