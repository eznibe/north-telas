...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	else if(isset($_GET['deleteODModelMeasurement'])) {

		$response = deleteODModelMeasurement($_GET['id']);

		//return JSON array
		exit(json_encode($response));
	}
	else if(isset($_GET['deleteODModelItem'])) {

		$response = deleteODModelItem($_GET['id']);
